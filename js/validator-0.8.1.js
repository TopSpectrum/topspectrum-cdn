 ...
 *
 *
 * THIS FILE WAS SIGNIFICANTLY CUSTOMIZED. DO NOT UPDATE IT.
 *
 */
+function ($) {
    'use strict';

    var inputSelector = ':input:not([type="submit"], button):enabled';
    // VALIDATOR CLASS DEFINITION
    // ==========================

    /**
     * Generally called on the whole form.
     *
     * @returns {boolean}
     */
    ...
    function isStrictMode(context) {
        return !!(context && context.submit);
    }

    Validator.prototype.runValidators = function ($el, context) {
        context = context || {};
        var errors = [];
    ...
    Validator.prototype.validate = function (boolCalledViaFormSubmit) {
